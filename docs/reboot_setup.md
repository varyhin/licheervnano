...
Как работает программная перезагрузка на mainline-стеке и что понадобилось, чтобы она заработала. Статус подтверждён на железе 2026-07-04. Механизм сброса (фикс A) общий для всех вариантов B/E/W/WE. Возврат Wi-Fi после reboot (фикс B) проверен на W, несколько reboot подряд и переключение B→nano-w.
