...
Проверка одной командой на плате, печатает PASS/FAIL по каждому пункту:

```
scripts/check-wifi.sh              # проверить радио
scripts/check-wifi.sh 6778e152     # плюс сверить метку прошитого образа
```
