...
| GND | - | - | - | GND |
| GPIOA 15 | 17 | SPK_EN | XGPIOA[15] (FMUX `0x0300_103C` func 3 = reset-дефолт; TRM: others reserved, CAM_RST0 на этом паде нет) | gpiochip0 line 15, занят драйвером sound_dac как spk-en-gpios (enable AW8010A, -EBUSY для userspace), патчи 0012/0013 |
