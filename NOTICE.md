...
- aic8800_u03/ это прошивка Wi-Fi/BT чипа AIC8800D80, правообладатель
  AICSemi. Блобы взяты побитово (sha256 совпадает) из зеркала
  gtxaspec/aic8800-wifi (каталог SDIO/driver_fw/fw/aic8800/), которое
  перераспространяет прошивку AIC
...
- RV_Nano_3.jpg это распиновка 2x14 header из публичной Sipeed wiki
  (wiki.sipeed.com), перераспространяется как справочный материал.
  При несогласии правообладателя файл подлежит замене на внешнюю ссылку.
