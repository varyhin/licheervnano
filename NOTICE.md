...
проекта: Makefile, manifest/, scripts/, tools/ (кроме vendor-патчей),
extlinux/, docs/, README.
...
| src/cviruntime, src/cvikernel, src/cvibuilder, src/cnpy | github.com/sophgo/* | см. upstream |
| src/zlib | github.com/madler/zlib | zlib |
