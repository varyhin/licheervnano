...
| cviruntime, cvikernel, cvibuilder, cnpy, zlib | см. манифест | userspace TPU-рантайм |
...
| `scripts/` | refetch, usb-gadget, гигиена SSH-ключей, аудио-диагностика |
| `tools/` | host-side TPU-пайплайн: контейнер tpu-mlir, кросс-сборка cviruntime |
...
| TPU (0.5 TOPS INT8, BF16) | работает | [docs/tpu_setup.md](docs/tpu_setup.md) |
...
(`soph_tpu.ko`, собирается автоматически) и кросс-собранный userspace
рантайм. Компиляция моделей в формат cvimodel делается контейнером
tpu-mlir. Полный пайплайн от ONNX до запуска на плате описан в
[docs/tpu_setup.md](docs/tpu_setup.md), методика замеров в
[docs/tpu_benchmark_methodology.md](docs/tpu_benchmark_methodology.md).
Якорные цифры: mobilenet_v2 BF16 около 22 мс, yolov5s INT8 с
INT8-вводом около 77 мс на 700 МГц.
