...
Обзор блока TPU в [docs/tpu_sg2002.md](docs/tpu_sg2002.md). Якорная
цифра: mobilenet_v2 BF16 около 22 мс на 700 МГц.
...
Русский это первичный язык документации этого репозитория, английский
и китайский README это переводы.
